...
pacman::p_load(sf, spdep, tmap, tidyverse,funModeling,ggpubr,corrplot,rgdal, 
               ...
               heatmaply, psych, ClustGeo, ggparcoord)
```
...
After plotting the percentage of rural areas, it can be observed that the regions with high percentage of rural areas may have lower number of total water points in the respective region.
It can be said that there are very high percentage of rural areas in the Nigeria as compared to the urban areas. This implies the country is poor country, struggling for basic necessities.
...
It can be **observed** that maximum number of observations are in Cluster 2 followed by Cluster 1.
